...
- Events with `parent_possession_xg > 0` after fix: **1,020** (carries now properly linked via frame-range containment).
...
sideways         3514  0.011429      0.781161         0.000285     0.140581        0.463310
```
