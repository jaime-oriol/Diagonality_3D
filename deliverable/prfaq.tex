...
\textbf{tests the theory}: the essay's argument is distilled into four
falsifiable hypotheses and checked against 6{,}923 passes, carries and
take-ons with metrics that owe nothing to the new model. The claims hold.
...
visible --- and, in a second amber layer, which high-value options the
carrier has stopped watching and should turn to re-check.
...
\faq{Why does 3D skeleton data matter --- couldn't this be done with
ordinary tracking?}
No. Ordinary tracking gives positions; body orientation then has to be
...
\faq{Is DOS biased by hindsight --- does it secretly use outcomes?}
