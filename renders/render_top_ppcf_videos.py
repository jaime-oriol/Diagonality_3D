...
PPCF reach-field render pipeline (compute_ppcf_surfaces on n_grid_x=100,
plot via ppcf_plot.plot_ppcf_frame), parameterized to render ANY event
from `outputs/tables/top_dos_events.json`.
